...
pub trait InternetControlMessageProtocolVersion6TypeAndCodeVisitor<R>
{
	...
	fn identifier_locator_network_protocol_for_internet_protocol_version_6_locator_update(&self, identifier_locator_network_protocol_for_internet_protocol_version_6_locator_update: InternetControlMessageProtocolVersion6CodeIdentifierLocatorNetworkProtocolLocatorUpdate) -> R;
