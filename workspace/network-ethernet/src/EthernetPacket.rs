...
impl EthernetPacket
{
	...
	#[inline(always)]
	fn unsupported_ether_type<'ethernet_addresses, EINPDO: EthernetIncomingNetworkPacketDropObserver>(ethernet_addresses: &'ethernet_addresses EthernetAddresses, potentially_invalid_ether_type: EtherType) -> EthernetIncomingNetworkPacketDropReason<'ethernet_addresses, EINPDO::ARPINPDR, EINPDO::IPV4INPDR, EINPDO::IPV6INPDR>
	{
