...
impl InternetProtocolVersion4NetworkAddress
{
	...
	#[inline(always)]
	pub fn is_invalid_unicast_for_network(&self, internet_protocol_host_address: <InternetProtocolVersion4NetworkAddress as InternetProtocolNetworkAddress>::HostAddress) -> bool
	{
